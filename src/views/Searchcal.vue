    ...
    <div>
        <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item>
                    <i class="el-icon-lx-cascades"></i> 理算
                </el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="container">
            ...
            <el-table :data="tableData" border class="table" ref="multipleTable" header-cell-class-name="table-header"
                            ...
                            <transition name="fade">
                                <div>
                                    ...
                                    <div>
                                        ...
                                        <el-checkbox v-model="showColumn.CalStage">称重状态</el-checkbox>
                                        <el-checkbox v-model="showColumn.CalNum">理算重量</el-checkbox>
                                        <el-checkbox v-model="showColumn.CalTime">执行日期</el-checkbox>
                ...
                <el-table-column prop="CalStage" label="称重状态" v-if="showColumn.CalStage"></el-table-column>
                <!-- <el-table-column prop="CalPerson" label="结算人" width="100" align="center" :formatter="recordLogData">
                </el-table-column> -->
                <el-table-column prop="CalNum" label="理算重量" width="80" align="center" v-if="showColumn.CalNum">
                </el-table-column>
                <el-table-column prop="CalTime" label="执行日期" width="100" align="center" v-if="showColumn.CalTime">
                </el-table-column>
...
const research = async () => {
    ...
    //     name: form.value
    // }
    const res = await weightapi.search_data_cal(query)
