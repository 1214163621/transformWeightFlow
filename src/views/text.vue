<template>
  <div>
    ...
    <div class="container">
      ...
      <el-table id="ou" :data="tableData" border class="table" ref="multipleTable" header-cell-class-name="table-header"
        stripe :span-method="arraySpanMethod">
      ...
      <div class="pagination">
        <el-pagination background layout="total, prev, pager, next, sizes" :current-page="query.pageIndex"
          :page-size="query.pageSize" :page-sizes="[5, 10, 20, 50]" :total="pageTotal" @size-change="handleSizeChange" @current-change="handlePageChange"></el-pagination>
      </div>
    </div>
  </div>
</template>
